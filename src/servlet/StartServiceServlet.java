...
public class StartServiceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action == null || action.trim().length() == 0) {
			out.print("启动：" + "http://127.0.0.1:8080/DhtSearch/servlet/StartServiceServlet?action=start");
			out.println("<br>");
			out.print("停止：" + "http://127.0.0.1:8080/DhtSearch/servlet/StartServiceServlet?action=stop");
			out.println("<br>");
			out.print("查看状态：" + "http://127.0.0.1:8080/DhtSearch/servlet/StartServiceServlet?action=state");
